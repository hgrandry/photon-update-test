...
namespace Photon.Voice.Unity
{
    ...
    public class VoiceLogger : Voice.ILogger
    {
        ...
        public void LogError(string fmt, params object[] args)
        {
            ...
            {
                string.Format(fmt, args).LogError<VoiceLogger>();
            }
            else
            {
                string.Format(fmt, args).LogError<VoiceLogger>(this.context);
            }
        }
        ...
        public void LogWarning(string fmt, params object[] args)
        {
            ...
            if (this.context == null)
            {
                string.Format(fmt, args).LogWarning<VoiceLogger>();
            }
            else
            {
                string.Format(fmt, args).LogWarning<VoiceLogger>(this.context);
            }
        }
        ...
        public void LogInfo(string fmt, params object[] args)
        {
            ...
            if (this.context == null)
            {
                string.Format(fmt, args).Log<VoiceLogger>();
            }
            else
            {
                string.Format(fmt, args).Log<VoiceLogger>(this.context);
            }
        }
